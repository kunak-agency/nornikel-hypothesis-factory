...
// RenderMarkdownReport builds a human-readable report: ranked hypothesis
// cards with mechanism, evidence, risks, and a verification roadmap —
// matching the "карточка, не свободный текст" format the case expects.
func RenderMarkdownReport(spec models.ProblemSpec, hyps []models.Hypothesis) string {
