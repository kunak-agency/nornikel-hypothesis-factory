...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/hypotheses/{hypothesisId}/verification-plan": {
            "put": {
                "consumes": [
                    "application/json"
                ],
                ...
                "parameters": [
                    ...
                    {
                        "description": "Шаги дорожной карты",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/in.UpdateVerificationPlanRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "in.UpdateVerificationPlanRequest": {
            "type": "object",
            "required": [
                "verificationPlan"
            ],
            "properties": {
                "verificationPlan": {
                    "description": "min=1: ` + "`" + `required` + "`" + ` на слайсе проверяет лишь non-nil, а JSON ` + "`" + `[]` + "`" + ` декодится в\nнепустой len-0 слайс и прошёл бы валидацию — пустой массив молча стёр бы\nсохранённую дорожную карту. min=1 закрывает это (пустой массив → 422).",
                    "type": "array",
                    "maxItems": 50,
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/in.VerificationStepInput"
                    }
                }
            }
        },
        "in.VerificationStepInput": {
            "type": "object",
            "required": [
                "step"
            ],
            "properties": {
                ...
                "resource": {
                    "type": "string",
                    "example": "Лаборатория ОФ, реагенты"
                },
                "step": {
                    "type": "string",
                    "example": "Лабораторный тест флотации при pH 9.5"
                },
                "successCriterion": {
                    "type": "string",
                    "example": "Извлечение Ni +1.5% против базы"
                }
            }
        },
