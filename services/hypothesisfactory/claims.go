...
[
  {
    "subject": "объект воздействия, напр. 'расход собирателя в основной флотации'",
    "subject_kind": "equipment | reagent | process | material | metric | other — тип объекта voздействия",
    "action": "конкретное действие/изменение, напр. 'повышение с 40 до 60 г/т'",
...
без обоснования (напр. список из мозгового штурма технолога — "изменить плотность пульпы в основной флотации",
"опробовать колонную флотацию"). В этом случае извлекай subject+action как есть, effect_direction="unspecified",
